  ...
  return (
    ...
    >
      <Card
        ...
        border-gray-200 dark:border-[#1A2A45] 
        p-6
      "
      >
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <h2 className="text-5xl font-extrabold mt-2 text-blue-600 dark:text-green-400">
                DEVELOPER
              </h2>

              <div className="mt-8 space-y-2 text-lg text-black dark:text-white">
          ...
          <motion.div
            ...
            className="mt-10"
          >
            <h3 className="text-2xl font-semibold text-blue-600 dark:text-green-400 mb-4">
              My Services
            </h3>
